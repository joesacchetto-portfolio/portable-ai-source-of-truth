...
- **Authority level** — how strongly future assistants should rely on it (`governance/authority_levels.md`). New material enters as a tentative working note or lower — never directly as a locked fact.
...
**2. Check the boundary.** Does the change touch anything that always needs your explicit approval — approved content, locked facts, governance files, deletions, anything about other people? (`governance/approval_boundaries.md`.) If yes, slow down and review that item by itself.
...
- **Durable enough for its target file?** A current-work detail proposed for locked facts is in the wrong place, even if true. Put it in the file where it actually belongs.
...
**4. Decide: accept, edit, move to a better file, or reject.** Partial acceptance is normal — take the fact, cut the editorializing. The assistant applies exactly what you accepted, nothing more.
...
- A proposal to "clean up" or "clarify" approved content — rewording can change meaning. Compare the old and new wording carefully before accepting it.
