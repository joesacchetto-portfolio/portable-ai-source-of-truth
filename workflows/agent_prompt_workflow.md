...
*Tip: if your tool auto-loads a `CLAUDE.md` or `AGENTS.md` instructions file, copy the matching file from `templates/` into place once — then step 2 happens automatically in every session.*
